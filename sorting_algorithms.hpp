...
namespace sorting_algorithms{
	...
	template<typename T, typename Comp = cmp>//(+)	 	                  	//O(n^2)
	void bsort(T& array, Comp&& cmp_ = Comp{}){  
	int counter = 1;  	
	...
	void even_odd_sort(T& array, Comp&& cmp_ = Comp{}){
		bool isSorted = false;
		auto x = array[i];
